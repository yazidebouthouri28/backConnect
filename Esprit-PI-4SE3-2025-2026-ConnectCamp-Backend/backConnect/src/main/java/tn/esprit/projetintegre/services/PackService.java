...
public class PackService {
    ...
    public Page<PackDTO.Response> getAllAdmin(Pageable pageable) {
        ...
        return packRepository.findAll(pageable).map(this::toResponse);
    }
    ...
    private PackDTO.Response toResponse(Pack pack) {
        return PackDTO.Response.builder()
                ...
                .serviceIds(pack.getServices() != null
                        ? pack.getServices().stream().map(tn.esprit.projetintegre.entities.CampingService::getId)
                                .toList()
                        : new java.util.ArrayList<>())
                .serviceNames(pack.getServices() != null
                        ? pack.getServices().stream().map(tn.esprit.projetintegre.entities.CampingService::getName)
                                .toList()
                        : new java.util.ArrayList<>())
                .build();
    }
