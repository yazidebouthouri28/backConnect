...
import tn.esprit.backconnect.dto.SponsorRequest;
import tn.esprit.backconnect.dto.SponsorshipRequest;
import tn.esprit.backconnect.dto.SponsorResponse;
import tn.esprit.backconnect.dto.SponsorshipResponse;
import tn.esprit.backconnect.entities.Sponsor;
import tn.esprit.backconnect.entities.Sponsorship;
import tn.esprit.backconnect.mapper.DtoMapper;
import tn.esprit.backconnect.services.SponsorService;
...
public class SponsorController {
    ...
    private Sponsorship toSponsorshipEntity(SponsorshipRequest request) {
        return Sponsorship.builder()
                ...
                .sponsorshipLevel(request.getSponsorshipLevel()) // Changé de tier à sponsorshipLevel
