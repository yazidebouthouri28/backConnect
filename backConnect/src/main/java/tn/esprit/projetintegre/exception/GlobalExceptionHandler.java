...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(tn.esprit.projetintegre.exception.AccessDeniedException.class)
    public ResponseEntity<ApiResponse<Object>> handleCustomAccessDeniedException(
            tn.esprit.projetintegre.exception.AccessDeniedException ex) {
        return ResponseEntity.status(HttpStatus.FORBIDDEN)
                .body(ApiResponse.error(ex.getMessage()));
    }
    ...
    public ResponseEntity<ApiResponse<Object>> handleGenericException(Exception ex) {
        ex.printStackTrace(); // Utile pour voir l'erreur exacte dans la console IDE
