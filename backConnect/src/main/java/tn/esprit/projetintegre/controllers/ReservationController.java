...
public class ReservationController {
    ...
    public ResponseEntity<ApiResponse<ReservationResponse>> createSiteReservation(
        ...
        Reservation reservation = reservationService.createSiteReservation(userId, siteId, campsiteId, packId, serviceIds,
                checkIn, checkOut, numberOfGuests, guestName, guestEmail, guestPhone, specialRequests);
