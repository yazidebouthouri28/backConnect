...
public interface EventRepository extends JpaRepository<Event, Long> {
    ...
    @Override
    @EntityGraph(attributePaths = {"site", "organizer", "requestedServices"}) // Charge les relations nécessaires
    Optional<Event> findById(Long id);

    @EntityGraph(attributePaths = {"site", "organizer", "requestedServices"})
